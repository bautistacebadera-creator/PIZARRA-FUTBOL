...
## Novedades de la v3 Profesional
- **Portada elegante en blanco y negro**: Animación de bienvenida profesional con diseño minimalista y sofisticado.
- **Sistema de Banquillo con Suplentes**: Podés agregar jugadores de cambio, mandar jugadores al banquillo y devolverlos al campo con botones dedicados.
- **Situaciones Tácticas Realistas**: Generador automático de situaciones tácticas predefinidas:
  - Ataque: Contraataque rápido, jugada de pared, centro al área, tiro lejano
  - Defensa: Presión alta, bloque bajo, cambio de banda
  - Tiros Libres: Cerca y lejos del área
- **Simulación con Física Realista**: Movimientos con velocidades variables (pases más rápidos que carreras) y funciones de aceleración realistas.
- **Diseño Visual 3D Profesional**: Gradientes, sombras, brillos y efectos de profundidad en toda la interfaz.
- **Optimizaciones de Rendimiento**: Uso de useMemo y useCallback para mejor performance.
- **Responsividad Mejorada**: Optimizado para celular, tablet y escritorio con controles táctiles mejorados.
- **Eliminación de Selección Indeseada**: Ya no se selecciona texto al arrastrar fichas.
...
## Qué incluye
- `index.html` — página principal con portada elegante y sistema optimizado
- `app.jsx` — código fuente completo con React, ahora compila en el navegador con Babel
...
- La primera vez que se abre necesita internet (para traer React, ReactDOM y Babel
  desde el CDN). Después de esa primera carga, el service worker la cachea
  y abre offline.
- Esta versión v3 usa compilación JIT (Just-In-Time) con Babel en el navegador,
  lo que permite ediciones rápidas sin proceso de build, pero requiere conexión
  a internet para la primera carga.

## Características Principales
- ✅ Portada elegante en blanco y negro con animaciones
- ✅ Sistema de banquillo con suplentes
- ✅ Situaciones tácticas predefinidas (ataque, defensa, tiros libres)
- ✅ Simulación con física realista
- ✅ Diseño 3D profesional con gradientes y sombras
- ✅ Responsivo para celular, tablet y escritorio
- ✅ Optimizado con useMemo y useCallback
- ✅ Sin selección de texto al arrastrar
- ✅ Todo en español
