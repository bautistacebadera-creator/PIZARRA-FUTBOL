    ...
    scenarios: [
      {
        ...
        setup: (teamA, teamB, ball) => {
          // Posicionar jugadores para contraataque
          const newArrows = [
          ...
          return { arrows: newArrows, ball: { x: 50, y: 130 } };
        }
      },
      {
        id: 'pared',
        ...
        setup: (teamA, teamB, ball) => {
          ...
          return { arrows: newArrows, ball: { x: 50, y: 100 } };
        }
      },
      {
        id: 'centro',
        ...
        setup: (teamA, teamB, ball) => {
          ...
          return { arrows: newArrows, ball: { x: 15, y: 70 } };
        }
      },
      {
        id: 'tiro_lejano',
        ...
        setup: (teamA, teamB, ball) => {
          ...
          return { arrows: newArrows, ball: { x: 50, y: 90 } };
        }
      }
    ]
  },
    ...
    scenarios: [
      {
        ...
        setup: (teamA, teamB, ball) => {
          ...
          return { arrows: newArrows, ball: { x: 50, y: 35 } };
        }
      },
      {
        id: 'bloque_bajo',
        ...
        setup: (teamA, teamB, ball) => {
          ...
          return { arrows: newArrows, ball: { x: 50, y: 65 } };
        }
      },
      {
        id: 'cambio_banda',
        ...
        setup: (teamA, teamB, ball) => {
          ...
          return { arrows: newArrows, ball: { x: 20, y: 75 } };
        }
      }
    ]
  },
    ...
    scenarios: [
      {
        ...
        setup: (teamA, teamB, ball) => {
          ...
          return { arrows: newArrows, ball: { x: 30, y: 35 } };
        }
      },
      {
        id: 'tl_lejos',
...
function App() {
  ...
  function addNewBenchPlayer(team) {
    ...
    const newPlayer = {
      ...
      num: benchSetter === setBenchA ? benchA.length + 12 : benchB.length + 12,
      name: '',
      role: 'out',
      team,
    };
  ...
  function applyTacticalScenario(category, scenarioId) {
    ...
    const { arrows: newArrows, ball: newBall } = scenario.setup(teamA, teamB, ball);
